...
def main():
    ...
    base_folder = 'datasets/hTERT/'
    coord_folder = os.path.join(base_folder, 'hTERT AFM Coordinate Overlays')
    ...
    for cell_n in all_cells:
        ...
        fname_overlay_view = os.path.join(coord_folder, 'hTERT Cell %d %s.png' % (cell_n, view_types[view_type]))
        ...
        centered_all = [
            [
                ...
                [997.3538961, 1543.09285714, 90.],
                [1038.10714286, 769.12857144, 100.],
                [754.7, 819.68571428, 100.],
                [1073.53896103, 1743.33571428, 100.],
                [1532.19675325, 582.40714286, 60.],
                [ 484.66103896, 1489.87142857,  100.]

            ],

            [(None, None, None),
             [951.79220779, 1065.17857142, 60.],
             [827.06103896, 724.33571429, 90.],
             [1108.32532467, 1165.78571429, 90.],
             [1238.73961039, 1410.44285715, 90.],
             [1125.53961039, 986.30714286, 120.],
             [1264.87532467, 1400.1, 80.],
             [1076.56103896, 1210.08571429, 90.]]
        ]
