...
cell_numbers = [6, 7,] # already did #1; #6 and #7 are corrupted
base_dir = 'datasets/hTERT/'
specific_ds_base = 'hTERT %d/'
ome_fname_base = 'shear_hTERT %d_Reconstructed.ome.tif'
ome_fname_base = [
    '2021_05_21_hTERT %d_Reconstructed_crop_Sim 405.tif',
    '2021_05_21_hTERT %d_Reconstructed_crop_Sim 488.tif',
    '2021_05_21_hTERT %d_Reconstructed_crop_Sim 561.tif',
    '2021_05_21_hTERT %d_Reconstructed_crop_Sim 647.tif',
    ]

n_channels = 4 # number of channels in ome (sometimes there's 4)
keep3 = [3, 1, 2] # needs to be adjusted when there's 4 channels
