...
EXPORT_CONTOURS_TO = "export_contours/contours_parent_P%02d_%d_real"
ANNOTATION_FOLDER = 'Parent Cell %d/annotation'
TITLE = 'Parent_%d'
COMMENT = "AFM-C Parent Cell #%d"
SCALING_JSON = os.path.join('datasets/Parent/Parent Cell 1/annotation', 'scaling.json')
Z_SCALE = 0.1
