...
OUTPUT_DIR = '/Users/asears/work/confocal/lateral_features/'

with open(os.path.join(OUTPUT_DIR,f'xsection_summary.txt'),'w') as fout:
    fout.write('# mean of the (solidity, convexity, circularity) for each cross-section\n')
