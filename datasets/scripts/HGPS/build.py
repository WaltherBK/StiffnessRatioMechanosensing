...
EXPORT_CONTOURS_TO = "export_contours/contours_hgps_P%02d_%d_redo"
ANNOTATION_FOLDER = 'HGPS %d/annotation'
TITLE = 'HGPS_%d'
COMMENT = "AFM-C HGPS Cell #%d"
SCALING_JSON = os.path.join('datasets/SR_HGPS1/HGPS 1/annotation', 'new_scaling.json')
Z_SCALE = 0.1
